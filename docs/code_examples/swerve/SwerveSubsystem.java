...
public class SwerveSubsystem extends SubsystemBase
{
  ...
  // --8<-- [start:drive-field-oriented-void]
  /**
  ...
  // --8<-- [end:drive-field-oriented-void]

  // --8<-- [start:drive-field-oriented-command]
  /**
   * Drive the robot given a chassis field oriented velocity.
   *
   * @param velocity Velocity according to the field.
  ...
  // --8<-- [end:drive-field-oriented-command]

  // --8<-- [start:drive-chassis-speeds]
  /**
  ...
  // --8<-- [start:zero-gyro-with-alliance]
  /**
