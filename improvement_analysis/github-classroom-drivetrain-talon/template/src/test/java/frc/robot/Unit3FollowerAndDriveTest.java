 ...
 * HAL's simulated CAN device table — each new TalonFX registers a device.
 */
class Unit3FollowerAndDriveTest {
    ...
    void driveArcadeMethodSignature() throws NoSuchMethodException {
        Method m = CANDriveSubsystem.class.getDeclaredMethod(
    ...
    void driveArcadeCommandRequiresSubsystem() {
        ...
        assertTrue(
                ...
                "The Command returned by driveArcade must require CANDriveSubsystem — use 'this.run(...)' not 'Commands.run(...)'");
    }
