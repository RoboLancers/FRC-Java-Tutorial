...
public class ShooterSubsystemTalonFX extends SubsystemBase {

  private final TalonFX flywheelMotor;

  // --8<-- [start:limit-switch-field-talon]
  private final DigitalInput shooterLimitSwitch;
  // --8<-- [end:limit-switch-field-talon]

  // --8<-- [start:limit-switch-constructor-talon]
  public ShooterSubsystemTalonFX() {
    flywheelMotor = new TalonFX(0);
    // Create the limit switch on DIO port 0
    shooterLimitSwitch = new DigitalInput(0);
  }
  // --8<-- [end:limit-switch-constructor-talon]

  // --8<-- [start:limit-switch-method-talon]
  /**
  ...
  // --8<-- [end:limit-switch-method-talon]

  /**
   * Spins the shooter flywheel.
   */
  public void spinUp() {
    flywheelMotor.setVoltage(6.0);
  }
